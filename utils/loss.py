...
class SlideLoss(nn.Module):
    def __init__(self, loss_fcn, alpha=0.999):
    ...
    def forward(self, pred, true, auto_iou=0.5):
        ...
        if self.ema is None:
            ...
            self.ema = self.alpha * auto_iou + (1 - self.alpha) * self.ema

        b1 = true <= (self.ema - 0.1)
        a1 = 1.0
        b2 = (true > (self.ema - 0.1)) & (true < self.ema)
        a2 = math.exp(1.0 - self.ema)
        b3 = true >= self.ema
