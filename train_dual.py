...
from utils.autoanchor2 import check_anchors
...
from utils.general2 import (LOGGER, TQDM_BAR_FORMAT, check_amp, check_dataset, check_file, check_git_info,
...
# from utils.loss_tal_dual_snn import ComputeLoss
...
from utils.torch_utils2 import (EarlyStopping, ModelEMA, de_parallel, select_device, smart_DDP, smart_optimizer,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='resnet10-v9.yaml', help='model.yaml path')
