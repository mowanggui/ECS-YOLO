...
from utils.general2 import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from utils.torch_utils2 import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from models.experimental2 import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from export2 import export_formats
        from utils.downloads2 import is_url
...
class AutoShape(nn.Module):
    ...
    def _apply(self, fn):
        ...
        from models.yolo_snn import Detect, Segment
        if self.pt:
            m = self.model.model.model[-1] if self.dmb else self.model.model[-1]  # Detect()
